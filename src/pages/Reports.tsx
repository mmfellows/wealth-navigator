      ...
      {pacing && (
        <Card>
          ...
          {importableLegacy.length > 0 && (
            <div className="mb-4 flex items-center justify-between gap-3 text-sm bg-white/5 border border-ever-line text-ever-dim rounded-ever p-3">
              ...
              <button onClick={importLegacy} className="px-3 py-1.5 rounded-lg bg-ever-lime text-ever-lime-ink font-medium whitespace-nowrap">
                Import
              </button>
            </div>
          )}
